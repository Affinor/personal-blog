package com.jin.demo.personalblog.config;
 ...
 */
@Configuration
public class PBWebConfiguration extends WebMvcConfigurationSupport {
    /**
     * 1.这个为解决中文乱码
     * @return
     */
    ...
    protected void addViewControllers(ViewControllerRegistry registry) {
        registry.addViewController("/").setViewName("redirect:/article/selectByPage");
